...
class Ui_PanelCreateModel(QDialog):
    ...
    def setupUi(self):
        ...
        self.frmArchive = QtWidgets.QFrame(self)
        self.frmArchive.setGeometry(QtCore.QRect(0, 0, 1920, 1011))
        ...
        self.btnBackToMain.setGeometry(QtCore.QRect(1519, 910, 401, 31))
        font = QtGui.QFont()
...
"border-bottom: 1px;")
        ...
        self.vScrollArch.setGeometry(QtCore.QRect(1910, 30, 10, 881))
...
"}")
        ...
        self.treeArchive = QtWidgets.QTreeWidget(self.frmArchive)
        self.treeArchive.setGeometry(QtCore.QRect(1519, 6, 392, 904))
...
"};")
        ...
        self.label = QtWidgets.QLabel(self.frmArchive)
        self.label.setGeometry(QtCore.QRect(0, 0, 1519, 941))
    ...
    # def startCreateModel(self):
    #     th_model = threading.Thread(target=self.createModel)
    #     th_model.start()
    ...
    #             mlab.show()
    #
    #             self.readAndPasteTreeImgs(globalValues.pathImgs)
    #
    #         else:
    #             uiMes = Ui_mes_box()
    #             uiMes.lblStrInfo.setText('Не выбрана картинка!')
